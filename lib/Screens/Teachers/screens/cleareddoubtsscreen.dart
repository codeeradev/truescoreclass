...
class ClearDoubtsScreen extends StatefulWidget {
  const ClearDoubtsScreen({super.key});

  @override
  State<ClearDoubtsScreen> createState() => _ClearDoubtsScreenState();
}

class _ClearDoubtsScreenState extends State<ClearDoubtsScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.blue.shade700,
        title:  Text(
          "Clear Doubts by you :${doubts.length}",
