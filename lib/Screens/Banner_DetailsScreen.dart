...
class BannerDetailsscreen extends StatefulWidget {
  final String name; // Make it final and remove the redundant declaration

  const BannerDetailsscreen({super.key, required this.name});
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(
                      "A complete guide for ${widget.name} exam covering all subjects with mock tests and expert mentorship.",
